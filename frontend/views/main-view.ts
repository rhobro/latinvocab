    ...
    return html`
      <vaadin-vertical-layout style="width: 100%; height: 100%; align-items: stretch;" id="root">
        <vaadin-vertical-layout class="content"
                                style="flex-grow: 1; flex-shrink: 0; flex-basis: auto; align-items: stretch;" id="body">
          <vaadin-vertical-layout style="padding: var(--lumo-space-s); flex-direction: column;">
            <vaadin-form-layout>
              <vaadin-form-item>
              ...
              <vaadin-form-item>
                <vaadin-integer-field id="nQs" has-controls required min="1" max="1000" prevent-invalid-input has-value
              ...
              <vaadin-form-item>
                <vaadin-number-field id="time" has-controls max="600" step="1" has-value
              ...
              <vaadin-form-item>
                <vaadin-integer-field id="timePQ" has-controls min="1" max="60" prevent-invalid-input
            ...
            <vaadin-vertical-layout id="customizer"
                                    style="align-self: stretch; align-items: stretch;"></vaadin-vertical-layout>
          </vaadin-vertical-layout>
          <label id="wordCount" style="margin: var(--lumo-space-s); align-self: flex-end;">_ words</label>
        </vaadin-vertical-layout>
